...
<a href='?admin=themsp' style="color: blue;">Thêm sản phẩm</a><br>
...
<table>
	...
	/*------------Phan trang------------- */
		...
		$sql = $link->query("SELECT * FROM sanpham inner join danhmuc on sanpham.madm=danhmuc.madm ORDER by idsp DESC  LIMIT $from, $max_results"); 
