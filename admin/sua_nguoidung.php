...
<form action="update_nguoidung.php?idnd=<?php echo $idnd;?>" method="post" name="frm" onsubmit="return kiemtra()" enctype="multipart/form-data">
	<table>
    		...
    		<tr>
            	<td>Họ tên</td><td><input style="width: 40%;
  height: 30px;
  padding: 12px 20px;
  ...
  font-size: 16px;
  resize: none;" type="text" name="tennd" value="<?php echo $row['tennd'] ?>"/></td>
            </tr>
			<tr>
            	<td>Username</td><td><input style="width: 40%;
  height: 30px;
  padding: 12px 20px;
  box-sizing: border-box;
  border: 2px solid #ccc;
  ...
  background-color: #f8f8f8;
  font-size: 16px;
  resize: none;" type="text" name="user"  value="<?php echo $row['username'] ?>"/></td>
            </tr>
			<tr>
            	<td>Email</td><td><input style="width: 40%;
  height: 30px;
  padding: 12px 20px;
  box-sizing: border-box;
  border: 2px solid #ccc;
  ...
  background-color: #f8f8f8;
  font-size: 16px;
  resize: none;" type="text" name="email"  value="<?php echo $row['email'] ?>"/></td>
            </tr>
			<tr>
            	<td>Điện thoại</td><td><input style="
  height: 30px;
  padding: 12px 20px;
  box-sizing: border-box;
  border: 2px solid #ccc;
  ...
  background-color: #f8f8f8;
  font-size: 16px;
  resize: none;" type="text" name="dienthoai"  value="<?php echo $row['dienthoai'] ?>"/></td>
            </tr>
			<tr>
            	<td>Quyền</td><td>
