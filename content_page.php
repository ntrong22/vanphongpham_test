		...
		if(isset($_GET['content']))
			...
			elseif(isset($_GET['madm'])) {
					...
					?>
						...
						$total_results = mysqli_num_rows($link->query("SELECT * FROM sanpham where madm='{$_GET['madm']}'"));  
	...
	?>
                ...
                <div class="sanpham">			
					...
					<div class="sanphamcon">
					    <?php 
						    $sql1="select * from sanpham inner join danhmuc on sanpham.madm = danhmuc.madm where dequi=0 order by idsp  DESC limit 6 ";
							$result1= $link->query($sql1);
						?>
						<?php 
						  while ($row=mysqli_fetch_array($result1))
